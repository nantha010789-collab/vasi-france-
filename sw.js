...
const CORE = [
  ...
  appUrl("vasi-word-icon-192.png"),
  appUrl("vasi-word-icon-512.png"),
  appUrl("vasi-notifications.js"),
  appUrl("vasi-languages.js"),
  appUrl("vasi-navigation.js"),
  appUrl("vasi-region.js"),
  appUrl("vasi-airports.js"),
  appUrl("vasi-call.js"),
  appUrl("delete-account.html"),
  appUrl("business-account.html"),
  appUrl("group-order.html"),
];
...
self.addEventListener("push", (event) => {
  ...
  event.waitUntil(
    self.registration.showNotification(data.title || "VASI", {
      ...
      icon: appUrl("vasi-word-icon-192.png"),
      badge: appUrl("vasi-word-icon-192.png"),
